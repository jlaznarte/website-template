...
jQuery(function($) {
  ...
  var init_ga = function() {
    ...
    if (ga.data('t3') !== undefined) {
      window._gaq.push(
        ['t3._setAccount', ga.data('t3')], ['t3._setDomainName', ga.data('domain')], ['t3._setAllowLinker', true], ['t3._trackPageview']
      );
    }
  ...
  if (notify_cookie_usage !== 'true') {
    ...
    show_notification = function() {
      ...
      button = $('<a/>').addClass('close_notification').attr('title', cookie_close).on('click', hide_and_sign);
