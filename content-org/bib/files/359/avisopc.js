...
_htmlDivAviso +=  '<p>Utilizamos "cookies" propias y de terceros para elaborar información estadística y mostrarle publicidad personalizada a través del análisis de su navegación. Si continúa navegando acepta su uso. <a target="_blank" id="' + _idUrlMasInformacion + '" href="' + _urlMasInformacion + '">Más información y política de cookies</a>.</p>\n';
