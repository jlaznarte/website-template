...
var crossmark = {
	...
	sCrossMarkURL: '',
  //sStylesURL: '',
	sStylesURL: 'https://crossmark.crossref.org/stylesheets/v1.4/crossmark_widget.css',
	...
	scriptVersion: function() {
		//var script = $('script[src$="crossmark.js"]')[0] || $('script[src$="crossmark.min.js"]')[0];
		//var scriptName = script.src
		//var parts = scriptName.split("/");
		//var version = parts[parts.length - 2] == 'javascripts' ? 'v1.2' : parts[parts.length -2]
		var version = "v1.4";
	...
	activateDialog: function() {
		...
		$(this.sOpenSelector).click(function(){
			$('#crossmark-dialog-frame').attr('src', 'https://' +  that.sCrossMarkURL);
...
//var $ = jQuery.noConflict(); // assign the main jQuery object to $
...
jQuery(function($) {
  ...
  //hack for mobile behaviour, open new window rather than popup
  if($(window).width() < 600 === true) {
      $(crossmark.sOpenSelector).click(function() {
        window.open("https://"+crossmark.sCrossMarkURL);
        //$('.crossmark-tooltip').hide();
        $(crossmark.sTooltipSelector).hide();
      });
  } else {
    crossmark.activateDialog();
  }
