...
jQuery(function(a){a.datepicker.regional["mt"]={closeText:"Lest",prevText:"Ta Qabel",nextText:"Li Jmiss",currentText:"Illum",monthNames: ['Jannar','Frar','Marzu','April','Mejju','Gunju','Lulju','Awissu','Settembru','Ottubru','Novembru','Dicembru'],monthNamesShort: ['Jan', 'Fra', 'Mar', 'Apr', 'Mej', 'Gun','Lul', 'Awi', 'Set', 'Ott', 'Nov', 'Dic'],dayNames: ['Il-Hadd', 'It-Tnejn', 'It-Tlieta', 'L-Erbgha', 'Il-Hamis', 'Il-Gimgha', 'Is-Sibt'],dayNamesShort: ['Had', 'Tne', 'Tli', 'Erb', 'Ham', 'Gim', 'Sib'],
dayNamesMin: ['H','T','T','E','H','G','S'],weekHeader:"Gm",dateFormat:"dd/mm/yy",firstDay:1,isRTL:false,showMonthAfterYear:false,yearSuffix:""};a.datepicker.setDefaults(a.datepicker.regional["mt"])});
jQuery(function(a){a.datepicker.regional["ga"]={closeText:"Dún",prevText:"Roimhe",nextText:"Aghaidh",currentText:"Inniu",monthNames: ["Eanáir","Feabhra","Márta","Aibreán","Bealtaine","Meitheamh","Iúil","Lúnasa","Meán Fómhair","Deireadh Fómhair","Samhain","Nollaig"],monthNamesShort: ["Ean","Feabh","Már","Aib","Bealt","Meith","Iúil","Lún","M.Fómh","D.Fómh","Samh","Noll"],dayNames: ["Domhnaigh","Luain","Máirt","Céadaoin","Déardaoin","Haoine","Sathairn"],dayNamesShort: ["Domh","Luan","Máir","Céad","Déar","Aoi","Sath"],
dayNamesMin: ["Do","Lu","Má","Cé","De","Ao","Sa"],weekHeader:"Sn",dateFormat:"dd/mm/yy",firstDay:1,isRTL:false,showMonthAfterYear:false,yearSuffix:""};a.datepicker.setDefaults(a.datepicker.regional["ga"])});