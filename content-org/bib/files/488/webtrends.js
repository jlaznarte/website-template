...
// Created: 8/24/2011 11:16:20 AM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid=webtrendsDcsid;
	this.domain=webtrendsDomain;
	this.timezone=1;
	this.fpcdom=webtrendsFrontOfficeDomain;
	this.onsitedoms="";
...
WebTrends.prototype.dcsGetId=function(){
	if (this.enabled&&(document.cookie.indexOf(this.fpc+"=")==-1)&&(document.cookie.indexOf("WTLOPTOUT=")==-1)){
		...
		document.write("<scr"+"ipt type='text/javascript' src='"+this.domain+"/"+this.dcsid+"/wtid.js"+"'><\/scr"+"ipt>");
	}
}
...
WebTrends.prototype.dcsFPC=function(){
	...
	if(acceptedCookies == "true") {
		var intExpire = 2592000000;
	}
	else {
		var intExpire = 0;
	}
	var dExp=new Date(dCur.getTime()+intExpire);
