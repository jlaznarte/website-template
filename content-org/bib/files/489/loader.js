...
// Load needed scripts for ENV
corporate.ready(function () {
	"use strict";

	// Load EC Components
	getScript('/wel/components/scripts/ec-components.js', function () {
		if (isIE) { components.run(); }
	});

	// Load useful scripts for ENV website
	getScript('/environment/scripts/jquery.min.js', function () {
		getScript('/environment/scripts/env.js', function () {});
	});
});
