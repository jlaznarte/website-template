...
jQuery.fn.extend({
	captify_reload: function(){
		$(this).each(function(){
			//To adjust to the height of the image
			$('.caption-wrapper').css('height', $(this).height());
			//$('.caption').css('height', $(this).height());
			$('.caption').css('width', $(this).width());
			//$('.caption_content').css( 'marginTop': -$('.caption').outerHeight());
		}); 
	},
	...
	captify: function(o){
		...
		$(this).each(function(){
			...
			$(this).load(function(){
				...
				var captionContent 	= $('div:last', wrapper.append('<div></div>')).addClass(o.className + " caption_content").append(o.prefix).append(captionLabelHTML);
				var captionContent_resp 	= $('div:last', wrapper.append('<div></div>')).addClass(o.className+"_resp").append(o.prefix).append(captionLabelHTML);
