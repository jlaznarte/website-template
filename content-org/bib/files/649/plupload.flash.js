...
(function(window, document, plupload, undef) {
	...
	plupload.runtimes.Flash = plupload.addRuntime("flash", {
		...
		init : function(uploader, callback) {
			...
			flashContainer.innerHTML = '<object id="' + uploader.id + '_flash" width="100%" height="100%" style="display:block; outline:0" type="application/x-shockwave-flash" data="' + uploader.settings.flash_swf_url + '">' +
