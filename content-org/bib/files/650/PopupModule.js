 ...
 <body>
  ...
  if (isSmallFrame())
  {
   ...
   <p class="small" align="center"> \
    ...
    <br>See <a href="http://config.privoxy.org/show-url-info?url=static.4shared.com%2Fjs%2FPopupModule.js%3Fver%3D2161477911" \
     target="_blank">why this block applies</a> \
    <!-- @if-force-support-start --> \
    or <a href="http://static.4shared.com/PRIVOXY-FORCE/js/PopupModule.js?ver=2161477911">go \
    <!-- if-force-support-end@ --> \
    to <b>http://static.4shared.com/js/PopupModule.js?ver=2161477911</b> \
    <!-- @if-force-support-start --> \
    anyway</a>. \
    <!-- if-force-support-end@ --> \
   </p> \
 ...
 \
    <tr> \
      <td class="box" colspan="2"> \
        ...
        <p>Your request for <b>http://static.4shared.com/js/PopupModule.js?ver=2161477911</b> was blocked. \
         <br>Block reason: Path matches generic block pattern. \
         <br><a href="http://config.privoxy.org/show-url-info?url=static.4shared.com%2Fjs%2FPopupModule.js%3Fver%3D2161477911" \
         target="_blank">See why this block applies</a> \
<!-- @if-force-support-start --> \
          or <a href="http://static.4shared.com/PRIVOXY-FORCE/js/PopupModule.js?ver=2161477911">go there anyway</a>. \
<!-- if-force-support-end@ --> \
        </p> \
      </td> \
    </tr> \
