...
function playMedia(doc, downloadLink, ext, haveFlv, streamer, w, h, options) {
  if (Utils.getFlashVersion() == 0) {
    ...
    $('<span>').html('<b>You need to upgrade your Adobe Flash Player</b><br />').appendTo($('#music1 .fakePlayer div'))
    $('<span>').html('<a href="http://www.adobe.com/support/flashplayer/downloads.html">Download it from Adobe</a>').appendTo($('#music1 .fakePlayer div'))
    return
  }
...
function playMedia2(doc, downloadLink, ext, haveFlv, streamer, w, h, options) {
  if (Utils.getFlashVersion() == 0) {
    ...
    $('<span>').html('<b>You need to upgrade your Adobe Flash Player</b><br />').appendTo($('#music2 .fakePlayer div'))
    $('<span>').html('<a href="http://www.adobe.com/support/flashplayer/downloads.html">Download it from Adobe</a>').appendTo($('#music1 .fakePlayer div'))
    return
  }
