 ...
 <body>
  ...
  if (isSmallFrame())
  {
   ...
   <p class="small" align="center"> \
    Request blocked by <a href="http://config.privoxy.org/" target="_blank">Privoxy</a>: Catch-all block for false-positives. \
    <br>See <a href="http://config.privoxy.org/show-url-info?url=static.4shared.com%2Fjs%2Fadlogger_tracker.js%3Fver%3D631600940" \
     target="_blank">why this block applies</a> \
    <!-- @if-force-support-start --> \
    or <a href="http://static.4shared.com/PRIVOXY-FORCE/js/adlogger_tracker.js?ver=631600940">go \
    <!-- if-force-support-end@ --> \
    to <b>http://static.4shared.com/js/adlogger_tracker.js?ver=631600940</b> \
    <!-- @if-force-support-start --> \
    anyway</a>. \
    <!-- if-force-support-end@ --> \
   </p> \
 ...
 \
    <tr> \
      <td class="box" colspan="2"> \
        ...
        <p>Your request for <b>http://static.4shared.com/js/adlogger_tracker.js?ver=631600940</b> was blocked. \
         <br>Block reason: Catch-all block for false-positives. \
         <br><a href="http://config.privoxy.org/show-url-info?url=static.4shared.com%2Fjs%2Fadlogger_tracker.js%3Fver%3D631600940" \
         target="_blank">See why this block applies</a> \
<!-- @if-force-support-start --> \
          or <a href="http://static.4shared.com/PRIVOXY-FORCE/js/adlogger_tracker.js?ver=631600940">go there anyway</a>. \
<!-- if-force-support-end@ --> \
        </p> \
      </td> \
    </tr> \
