...
var hcBase = lpfcProtocol + '://server.lon.liveperson.net/hc/'+lpNumber+'/';
var hcImageURL = lpFixProtocol("http://server.lon.liveperson.net/hcp/woman/5/en/");
...
if (hcMAC)
{
	document.writeln("<div style='visibility:hidden'><img src='" + lpfcProtocol + "://server.lon.liveperson.net/hcp/window/common/spacer.gif' id='hcControlImage' name='hcControlImage'></div>");
...
function hcPlaceLayersIE()
{
	hcWriteDoc('<iframe name="hcpopuplayer" id="hcpopuplayer" src ="' + lpfcProtocol + '://server.lon.liveperson.net/hcp/html/blankhtml.html" width="300" height="100" scrolling="no" frameborder="0" style="z-index:88;position:absolute;visibility:hidden;left:10px;top:10px"></iframe>');
...
function activateCobrowsePlugin() {
    with (lpTopFrame) {
        ...
        if ((typeof(document["CBAgent"])=="undefined") || (document["CBAgent"] == null)) {
            var scrtag1 = '<scr'+'ipt language="JavaScript" src="' + lpfcProtocol + '://server.lon.liveperson.net/hcp/html/lpcbtop.js" defer></scr'+'ipt>';
            var scrtag2 = '<scr'+'ipt language="JavaScript" src="' + lpfcProtocol + '://server.lon.liveperson.net/hcp/html/lpcb.js" defer></scr'+'ipt>';
            var screlem1=document.createElement(scrtag1);
            var screlem2=document.createElement(scrtag2);
            var tag = '<applet code="CBAgent.class" codeBase="' + lpfcProtocol + '://server.lon.liveperson.net/applets/v7.8" archive="cbagent.jar" name="CBAgent" width=0 height=0 style="LEFT: 0px; TOP: 0px; POSITION: absolute" mayscript></applet>';
